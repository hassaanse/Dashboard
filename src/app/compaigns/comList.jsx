...
export default function StickyHeadTable() {
  ...
  //   setActivatedButtons((prevState) => ({
  //     ...prevState,
  //     [campaignId]: true, // Mark the specific button as activated
  //   }));
  //   console.log(campaignId);
  //   setDivCampId(campaignId);
              ...
              .map((row, index) => {
                return (
                  <TableRow hover role="checkbox" tabIndex={-1} key={row.code}>
                    ...
                    <TableCell key={index} align="center">
                      {/* <Button onClick={() => handleOpen('https://thekoi.ca/backened/' + row.video)} variant="contained">Play Video</Button> */}
